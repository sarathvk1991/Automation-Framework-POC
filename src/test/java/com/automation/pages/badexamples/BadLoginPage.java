...
public class BadLoginPage {
    ...
    // [S2]  All three login locators hardcoded inline again
    ...
    // [S10] Third copy — checkout locator 3rd inline occurrence
    ...
    // [S10] Fourth copy — checkout locator 4th inline occurrence
    ...
    // [S10] Fifth copy — checkout locator 5th inline occurrence
    ...
    // [S10] Sixth copy — checkout locator 6th inline occurrence
    ...
    public String runEndToEndTest() {
        ...
        // Checkout — locator hardcoded inline again
        driver.findElement(By.id("checkout")).click();                  // [S2][S12]
    ...
    // [S2] By.cssSelector(".shopping_cart_link") repeated — second inline copy in this class
    // [S12] Direct element access without wait
    ...
    // [S2] By.id("first-name") hardcoded — wrong concern inside login page (SRP violation)
    // [S2] "Sarath", "Tester", "695001" hardcoded form values
    // [S2] "Sauce Labs Backpack" hardcoded product name — wrong concern
    ...
    public void fillAndVerify() {
        ...
        System.out.println("Backpack visible: " + item.isDisplayed());            // [S6]
    }
