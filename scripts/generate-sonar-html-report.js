...
const totalIssues = sonarData.total || 0;
const effortTotal = sonarData.effortTotal || 0;
 
const summaryMessage = totalIssues === 0
    ? '<p style="color:green; font-weight:bold;"> No issues found</p>'
    : `<p><strong>Total Technical Debt:</strong> ${effortTotal} minutes</p>`;
...
<head>
    ...
    <style>
        ...
        .BLOCKER { color: darkred; font-weight: bold; }
...
// ✅ ONLY SHOW TABLE WHEN ISSUES EXIST
if (issues.length > 0) {
    html += `
    <table>
        <tr>
